 ...
 * @LastEditTime : 2020-05-23 21:42:04
 * @Description: 商家卡片
 */
...
Component({
  ...
  methods: {
    ...
    clickLinkHandler(){
      ...
      this.triggerEvent('clickLinkHandler');
    },
    clickContentHandler(){
      console.log('clickContentHandler');
      this.triggerEvent('clickContentHandler');
    },
    clickThumbHandler(){
      console.log('clickThumbHandler');
      this.triggerEvent('clickThumbHandler');
    }
